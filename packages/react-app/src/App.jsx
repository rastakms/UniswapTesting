...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "Shambit", "purpose");
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Menu style={{ textAlign: "center" }} selectedKeys={[route]} mode="horizontal">
          ...
          <Menu.Item key="/first-token">
            <Link
              onClick={() => {
                setRoute("/first-token");
              }}
              to="/first-token"
            >
              First Token
          ...
          <Menu.Item key="/second-token">
            <Link
              onClick={() => {
                setRoute("/second-token");
              }}
              to="/second-token"
            >
              Second Token
